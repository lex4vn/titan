...
<?php get_header(); ?>
    ...
    <div id="content" class="col-full">
		...
		<section id="main" class="col-left archive-section">

		<?php if (have_posts()) : $count = 0; ?>
        
            <?php if (is_category()) { ?>
        	<header class="archive-header">
				<span class="archive-rss">
					<?php echo date("D M j G:i:s T Y");   ?>
					<?php $cat_id = get_cat_ID( single_cat_title( '', false ) ); echo '<a href="' . get_category_feed_link( $cat_id, '' ) . '">' . __( 'RSS', 'woothemes' ) . '</a>'; ?></span>
